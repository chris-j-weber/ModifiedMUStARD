class Config:
    ...
    modified = False
    use_sbert = False
    use_sbert_token = False
    use_universal = False
    use_balanced = False
    use_only_speaker = False
...
class SpeakerIndependentTConfigModifiedBalanced(Config):
    svm_scale = False
    use_target_text = True
    svm_c = 10
    speaker_independent = True
...
class SpeakerIndependentTConfigModifiedSBERT(Config):
    svm_scale = False
    use_target_text = True
    svm_c = 10
    speaker_independent = True
...
class SpeakerIndependentTConfigModifiedSBERTTOKEN(Config):
    svm_scale = False
    use_target_text = True
    svm_c = 10
    #speaker_independent = True
    #use_bert = False
    use_sbert_token = True
    modified = True


class SpeakerIndependentTConfigModifiedUniversal(Config):
    svm_scale = False
    use_target_text = True
    svm_c = 10
    #speaker_independent = True
...
class SpeakerDependend(Config):
    svm_scale = False
    use_target_text = True
    svm_c = 10
    use_only_speaker = True
...
CONFIG_BY_KEY = {
    ...
    'bert': SpeakerIndependentTConfigModifiedSBERT,
    'berttoken': SpeakerIndependentTConfigModifiedSBERTTOKEN,
    'universal': SpeakerIndependentTConfigModifiedUniversal,
    'i-t-b': SpeakerIndependentTConfigModifiedBalanced,
    'speaker': SpeakerDependend,
